...
Git clone the xao_SingleObjectToXmlJackson project into your workspace:
...
cd xao_SingleObjectToXmlJackson
mvn install -DskipTests

```

You man now import xao_SingleObjectToXmlJackson into your IDE.
